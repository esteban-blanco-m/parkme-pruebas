    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                Text("Users Name ", fontSize = 17.sp, textAlign = TextAlign.Center)
            }
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Icon(
                                ...
                                contentDescription = null,
                                modifier = Modifier.size(32.dp).clickable{navController.navigate(AppScreens.ChatCli.name)}
                            )
...
@Composable
fun OperatorProfile(navController: NavController) {
    var itemSeleccionado by remember { mutableIntStateOf(2) }
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                Text("Operators Name ", fontSize = 17.sp, textAlign = TextAlign.Center)
            }
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Icon(
                                ...
                                contentDescription = null,
                                modifier = Modifier.size(32.dp).clickable{navController.navigate(AppScreens.ChatOp.name)}
                            )
                            Text("Mensajes", fontSize = 10.sp, textAlign = TextAlign.Center)
                        }
                    }
